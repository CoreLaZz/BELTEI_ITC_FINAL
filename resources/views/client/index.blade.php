          ...
          <div class="row">
            <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
              <div class="banner-content content-padding">
                <h5 class="subtitle">BELTEI Internation Testing Center</h5>
                <h1 class="banner-title">ESL is for us to create ours.</h1>
                <p>BELTEI International University and BELTEI International Test Center in cooperation with Singapore International Mastery Contests Centre, organized Design 
                  Thinking with Robotics and Computational Thinking International Competition 2023 (DrCT 2023) for 15 students from 9 Schools in Phnom Penh, Cambodia.</p>
                <a href="{{route('contact')}}" class="btn btn-white btn-circled">lets start</a>
              </div>
            </div>
          </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row mb-5">
        <div class="col-lg-5 d-none d-lg-block col-sm-12 align-self-end">
          <div class="intro-img">
            <img src="{{asset('client/images/banner/why-choose.png')}}" alt="intro-img" class="img-fluid">
          </div>
        </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-3 col-sm-6 col-md-3 text-center">
          <img style="height:100px" src="{{asset('client/images/clients/client01.png')}}" alt="partner" class="img-fluid">
        </div>
        <div class="col-lg-3 col-sm-6 col-md-3 text-center">
          <img style="height:100px" src="{{asset('client/images/clients/client05.png')}}" alt="partner" class="img-fluid">
        </div>
        <div class="col-lg-3 col-sm-6 col-md-3 text-center">
          <img style="height:100px" src="{{asset('client/images/clients/client03.png')}}" alt="partner" class="img-fluid">
        </div>
        <div class="col-lg-3 col-sm-6 col-md-3 text-center">
          <img style="height:100px" src="{{asset('client/images/clients/client04.png')}}" alt="partner" class="img-fluid">
        </div>
      </div>
    </div>
  </section>
